...
fetch_i18n_from_release() {
    ...
    release_repo="${OPENLIST_FRONTEND_RELEASE_REPO:-etoile-7/OpenList-Frontend}"
    release_response=$(curl -s "https://api.github.com/repos/$release_repo/releases/tags/$git_version")
